...
def ui_faq(m):
    ...
    with st.expander("5. How are losses and other parameters obtained?"):
        ...
        st.warning("For data visualization, Hdc is rounded to 1A/m, the duty cycles are rounded in 10% steps, and temperature is reported using the set water temperature.")
